...
.btn-mystyle:hover {
    color: #fff;
    background: #94bbe9;
    background: radial-gradient(circle, #94bbe9 0%, #eeaeca 100%);
} */
...
.bg-gradient-mycolor {
    ...
    background-image: linear-gradient(180deg, #eeaeca 10%, #94bbe9 100%);
    background-size: cover
}
...
.bg-login-image {
    background: url(https://source.unsplash.com/-27u_GzlAFw/600x800);
